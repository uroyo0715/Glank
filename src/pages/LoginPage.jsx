    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-hint">
          Googleアカウントで続けます。複数のGoogleアカウントをお持ちの場合は、
          次の画面でどのアカウントを使うか選べます。
        </p>

        <button type="button" className="login-google-button" onClick={handleLogin} disabled={submitting}>
          <GoogleLogo />
          {submitting ? '接続中...' : 'Googleで続ける'}
        </button>
